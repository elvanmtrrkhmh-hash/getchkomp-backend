...
export default function Edit({
    ...
    const { data, setData, put, processing, errors } = useForm<Record<string, any>>({
        ...
        shipping_status: shipping.shipping_status || 'pending',
        tracking_number: shipping.tracking_number || '',
        shipping_date: shipping.shipping_date ? shipping.shipping_date.replace(' ', 'T').slice(0, 16) : '',
        estimated_delivery_date: shipping.estimated_delivery_date ? shipping.estimated_delivery_date.replace(' ', 'T').slice(0, 16) : '',
    });
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            {orders.length > 0 ? (
                                                ...
                                                <div className="p-2 text-sm text-muted-foreground italic text-center">No orders found</div>
                                            )}
                                        </SelectContent>
                                    </Select>
