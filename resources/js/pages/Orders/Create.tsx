...
export default function Create({ users }: { users: Option[] }) {
    ...
    // Status color mapping for visual feedback (optional but enhances UI)
            ...
            <div className="flex flex-col gap-8 p-6 mx-auto w-full max-w-4xl">
                <div className="flex items-center justify-between">
                    <div className="space-y-1">
                        ...
                        <p className="text-muted-foreground text-sm">Create and process new customer orders manually.</p>
                    </div>
                ...
                <Card className="shadow-xl border-muted-foreground/10 overflow-hidden bg-white/5 dark:bg-black/5 backdrop-blur-md">
                    <CardHeader className="bg-muted/10 pb-8 border-b border-muted/20">
                        ...
                        <CardDescription className="text-muted-foreground">
                            Fill in the customer information and order specifics below.
                        </CardDescription>
                    </CardHeader>
                    ...
                    <form onSubmit={submit}>
                        <CardContent className="space-y-8 pt-8 px-8">
                            ...
                            <div className="space-y-3">
                                ...
                                <Textarea
                                    id="shipping_address"
                                    placeholder="Enter full delivery details (Street, Building, City, Zip)..."
...
Create.layout = {
    breadcrumbs: [
        ...
        { title: 'Create', href: orders.create().url },
    ],
};