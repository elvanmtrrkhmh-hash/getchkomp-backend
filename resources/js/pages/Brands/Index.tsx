...
export default function Index(props: any) {
    ...
    const items = props['brands']?.data || props['brands'] || [];

    const handleDelete = (id: number) => {
        destroy(brands.destroy(id).url);
    };
        ...
        <>
            ...
            <div className="flex flex-col gap-4 p-4 h-full flex-1">
                <div className="flex justify-between items-center">
                    ...
                    <Button asChild>
                        <Link href={brands.create().url}>Create Brand</Link>
                    </Button>
                </div>
                                ...
                                <TableRow key={item.id}>
                                    ...
                                    <TableCell className="text-right space-x-2 flex justify-end">
                                        <Button variant="outline" size="sm" asChild>
                                            <Link href={brands.edit(item.id).url}>Edit</Link>
                                        </Button>
                                        <AlertDialog>
