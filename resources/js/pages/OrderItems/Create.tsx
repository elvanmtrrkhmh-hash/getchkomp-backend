...
import { Plus, Minus, Package, Hash, Banknote, ShoppingCart, ArrowLeft, Save } from 'lucide-react';
...
export default function Create({ orders, products }: { orders: OrderOption[], products: ProductOption[] }) {
            ...
            <div className="flex flex-col gap-8 p-6 mx-auto w-full max-w-4xl">
                <div className="flex items-center justify-between">
                    <div className="space-y-1">
                        ...
                        <p className="text-muted-foreground text-sm">Add individual products and quantities to an existing order.</p>
                    </div>
                ...
                <Card className="shadow-xl border-muted-foreground/10 overflow-hidden bg-white/5 dark:bg-black/5 backdrop-blur-md">
                    <CardHeader className="bg-muted/10 pb-8 border-b border-muted/20">
                        ...
                        <CardDescription className="text-muted-foreground">
                            Select the target order and the product to add.
                        </CardDescription>
                    </CardHeader>
                                ...
                                <div className="flex flex-col md:flex-row justify-between items-center bg-primary/5 dark:bg-primary/10 p-6 rounded-2xl border border-primary/20 shadow-inner group">
                                    <div className="flex items-center gap-3 mb-4 md:mb-0">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-muted-foreground font-medium uppercase tracking-widest text-[10px]">Estimated Subtotal</span>
...
Create.layout = {
    breadcrumbs: [
        ...
        { title: 'Create', href: orderItems.create().url },
    ],
};